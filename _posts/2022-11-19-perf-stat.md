...
Running `perf stat` on even this simple program results in the execution of 646,399 instructions, even though there are only three effective instructions [^1].
...
[^1]: see [this](https://stackoverflow.com/questions/56905811/what-does-the-endbr64-instruction-actually-do) on `endbr64` if you're curious what it does
